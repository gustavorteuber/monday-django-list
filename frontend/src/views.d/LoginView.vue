...
<template>
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      <h1 class="text-center text-2xl font-bold text-violet-600 sm:text-3xl">
      ...
      <form action="" class="mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl">
        ...
        <button
          ...
          type="submit"
          class="block w-full rounded-lg bg-violet-600 px-5 py-3 text-sm font-medium text-white"
        >
          Entrar
        </button>
