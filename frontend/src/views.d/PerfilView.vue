      ...
      <div class="px-5 xl:px-10 pb-10">
        ...
        >
          <div class="xl:pr-16 w-full xl:w-2/3">
            ...
            <p
              class="text-center xl:text-left mt-2 text-sm tracking-normal text-gray-600 dark:text-gray-400 leading-5"
            >
          ...
          >
            <div class="mr-6 xl:mr-10">
              <h2
                class="text-gray-600 dark:text-gray-400 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center"
              >
                82
              </h2>
              <p
                class="text-gray-800 dark:text-gray-100 text-sm xl:text-xl leading-5"
              >
                Reviews
              </p>
            </div>
          ...
          >
            ...
            >
              <div
                class="rounded-full bg-gray-200 text-gray-600 dark:text-gray-400 text-sm px-6 py-2 flex justify-center items-center"
              >
                Remote
              </div>
              <div
